...
Scatter.prototype.initVis = function () {
    ...
    this.color = d3.scale.linear()
        ...
        .range(["MidnightBlue", "MediumBlue ", "Blue ", "LightBlue ", "LightSkyBlue"]);
...
Scatter.prototype.updateVis = function () {
    ...
    this.data_fil = this.data.filter(function (d) {
        return parseFloat(d.properties.gdp) > 0 && parseFloat(d.properties.p1000) > 0;
    });
    ...
    this.x.domain(d3.extent(this.data.map(function (d) {
        return parseInt(d.properties.pcap);
    })));

    this.y.domain(d3.extent(this.data.map(function (d) {
        return parseFloat(d.properties.p1000);
    })));
    ...
    circle.selectAll("circle").transition()
        ...
        .attr("r", function (d) {
            return that.r(parseInt(d.properties.LE));
        })
